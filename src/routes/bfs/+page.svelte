<script lang="ts">
	...
	function findPath() {
		path = bfs(graph, start.toUpperCase(), goal.toUpperCase());
	}
...
<div class="space-y-8">
	<div class="bg-white p-6 rounded-lg shadow">
		<h2 class="text-2xl font-bold mb-4">Breadth-First Search</h2>
		<p class="mb-4">
			BFS is an uninformed search algorithm that explores all nodes at the present depth 
